...
static const std::vector<unsigned> offset_within_cell_freq = decode_vector(offset_within_cell_freq_str);
...
static const std::vector<unsigned> data_size_freq = decode_vector(data_size_freq_str);
