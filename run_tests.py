...
print(f"{Fore.YELLOW}Idx  {"Name":<{name_width}} {"Size":>7}   Compression   Decompression    Time {Style.RESET_ALL}")
...
for i, test_file in enumerate(test_files):
    ...
    print(f"{Fore.GREEN}OK{Style.RESET_ALL} {Fore.CYAN}{points:9.3f}{Fore.CYAN} {Fore.CYAN}{solution_time:9.3f}{Fore.CYAN}")
    n_ok += 1
    total_points += points
